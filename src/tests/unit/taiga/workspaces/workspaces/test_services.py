...
async def test_create_workspace():
    ...
    color = 5
    with (
        patch("workspaces.workspaces.services.workspaces_repositories", autospec=True) as fake_workspaces_repo,
        patch("workspaces.workspaces.services.ws_memberships_repositories", autospec=True) as fake_ws_memberships_repo,
    ):
...
async def test_create_workspace_detail():
    ...
    with (
        ...
        patch("workspaces.workspaces.services.get_workspace_detail", autospec=True) as fake_serializer_method,
    ):
...
async def test_get_my_workspaces_projects():
    ...
    with patch("workspaces.workspaces.services.workspaces_repositories", autospec=True) as fake_workspaces_repo:
...
async def test_get_workspace_detail():
    ...
    with (
        patch("workspaces.workspaces.services.workspaces_repositories", autospec=True) as fake_workspaces_repo,
        patch("workspaces.workspaces.services.projects_repositories", autospec=True) as fake_projects_repo,
    ):
...
async def get_workspace_nested():
    ...
    with (
        patch("workspaces.workspaces.services.workspaces_repositories", autospec=True) as fake_workspaces_repo,
        patch("workspaces.workspaces.services.ws_roles_services", autospec=True) as fake_ws_roles_services,
    ):
...
async def test_delete_workspace_without_projects():
    ...
    with (
        patch("workspaces.workspaces.services.workspaces_repositories", autospec=True) as fake_workspaces_repo,
        patch("workspaces.workspaces.services.projects_repositories", autospec=True) as fake_projects_repo,
        patch("workspaces.workspaces.services.workspaces_events", autospec=True) as fake_workspaces_events,
    ):
