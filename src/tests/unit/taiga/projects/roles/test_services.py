...
async def test_list_project_roles_as_dict():
    ...
    with patch("projects.roles.services.pj_roles_repositories", autospec=True) as fake_role_repository:
...
async def test_update_project_role_permissions_is_admin():
    ...
    with (
        patch("projects.roles.services.pj_roles_events", autospec=True) as fake_roles_events,
...
async def test_update_project_role_permissions_ok():
    ...
    with (
        patch("projects.roles.services.pj_roles_events", autospec=True) as fake_roles_events,
        patch("projects.roles.services.pj_roles_repositories", autospec=True) as fake_role_repository,
    ):
...
async def test_update_project_role_permissions_view_story_deleted():
    ...
    with (
        patch("projects.roles.services.pj_roles_events", autospec=True) as fake_roles_events,
        patch("projects.roles.services.pj_roles_repositories", autospec=True) as fake_role_repository,
        patch("projects.roles.services.permissions_services", autospec=True) as fake_permissions_service,
        patch(
